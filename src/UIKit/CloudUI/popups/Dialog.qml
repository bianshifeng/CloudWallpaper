...
PopupBase {
    ...
    height: Math.min(parent.height - 64 * g_dp,
                     headerView.height +
                     content.contentHeight +
                     (floatingActions ? 0 : buttonContainer.height))

    property int contentMargins: 24 * g_dp

    property int minimumWidth: g_isMobile ? 280 * g_dp : 300 * g_dp
    ...
    View {
        ...
        Item {
            ...
            height: hasActions ? 52 * g_dp : 2 * g_dp
