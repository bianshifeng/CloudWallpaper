...
View {
    ...
    implicitHeight: 1 * g_gridUnit * g_dp
    height: targetHeight
    elevation:!page ? 0 :( backgroundColor === page.color ? 0 : page.actionBar.elevation)
    fullWidth: true
    clipContent: true
    ...
    Rectangle {
        ...
        color: !page ? Theme.primaryColor:( page.rightSidebar && page.rightSidebar.actionBar.backgroundColor
    ...
    Controls.StackView {
        ...
        anchors {
            ...
            rightMargin: !page ? 0 :(page.rightSidebar ? page.rightSidebar.anchors.rightMargin : 0)
        }
