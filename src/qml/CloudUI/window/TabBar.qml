...
Item {
    ...
    property bool isLargeDevice: g_deviceType === 5 || g_deviceType === 4

    property bool fullWidth: isLargeDevice
            ? false : width - maxTabsWidth <= 16 * g_dp && tabsWidth <= width
    ...
    property int tabPadding: isLargeDevice ? 24 * g_dp : 12 * g_dp

    property int tabMinWidth: isLargeDevice ? 160 * g_dp: 72 * g_dp
    ...
    Component {
        ...
        View {
            ...
            implicitWidth: isLargeDevice
                    ? Math.min(2 * tabPadding + row.width, 264 * g_dp)
                    : Math.min(Math.max(2 * tabPadding + row.width, tabMinWidth), 264 * g_dp)
