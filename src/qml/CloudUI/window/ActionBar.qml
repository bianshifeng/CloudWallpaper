...
Item {
     ...
     * \since 0.3
     */
    property int iconSize: g_gridUnit === 48 * g_dp ? 20 * g_dp : 24 * g_dp
    ...
    function openOverflowMenu() {
        if (overflowMenuAvailable && !overflowMenuShowing)
            overflowMenu.open(overflowButton, 4 * g_dp, -4 * g_dp);
    }
    ...
    IconButton {
        ...
        anchors {
            ...
            left: parent.left
            leftMargin: leftItem.show ? 16 * g_dp : -leftItem.width
    ...
    Dropdown {
        ...
        width: 250 * g_dp
        height: columnView.height + 16 * g_dp
